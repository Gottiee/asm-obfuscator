...
from src.nbrs import obf_numbers, list_alias_nb, line_contains_nb
from src.strings import obf_strings
from src.struc import list_struc, obf_struc

def obf_line(line: str, obf_values: dict[str, str], obf_nbs: dict[str, str]) -> str:
	final_line: str = ""
...
def main (argv, argc):
	...
	with open(argv[1], "r") as r_file, open("obf_file.asm", "w") as w_file:
		for line in r_file:
			final_file += obf_line(line, obf_values, obf_numbers)
